    ...
    <div className="max-w-6xl mx-auto">
      ...
      {tenants.length === 0 ? (
        ...
        <div className="space-y-8">
          ...
          ).map(([propertyName, propertyTenants]) => (
            <div key={propertyName} className="bg-[#131A26] rounded-xl border border-slate-800 overflow-hidden shadow-lg">
              <div className="bg-slate-800/30 px-6 py-4 border-b border-slate-800 flex items-center justify-between">
                <h2 className="text-lg font-semibold text-white">{propertyName}</h2>
